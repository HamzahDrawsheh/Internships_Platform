...
export function ReportEmptyState() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">No internship tracking yet</h3>
      <p className="mt-2 text-sm text-gray-500">Follow these steps to start monthly reports:</p>
